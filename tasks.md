...
## Current Milestone: Phase 1 / Early Phase 3

- [x] XcodeGen project scaffold for iOS 26, Swift 6, SwiftUI
- [x] Accent color asset and generated app metadata
- [x] Monthly view shell with 6x7 grid
- [x] Liquid-glass-style top toolbar and bottom floating controls
- [x] Date tap opens Day View timetable sheet
- [x] Day View 24-hour timeline with current-time indicator and basic overlap split
...
- [ ] Implement Google sync and OAuth
